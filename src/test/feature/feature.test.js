...
describe("Bank Program", () => {
  it("it should be able to get and empty statement", () => {
  ...
  it("it should be able to make a deposit of 1000 and get a bank statement with transaction in it", () => {
    const bankBack = new BankBackEnd();
    const bankFront = new BankFrontEnd(bankBack);
  ...
  it("it should be able to make a deposit of 500 and get a bank statement with transaction", () => {
    const bankBack = new BankBackEnd();
    const bankFront = new BankFrontEnd(bankBack);
  ...
  it("it should be able to make a deposit, then a withdrawal and get a back statement with all transactions", () => {
    const bankBack = new BankBackEnd();
    const bankFront = new BankFrontEnd(bankBack);
    bankFront.deposit(500);
  ...
  it("should throw if withdrawal exeeds bank balance", () => {
    const bankBack = new BankBackEnd();
    const bankFront = new BankFrontEnd(bankBack);
    expect(() => {
